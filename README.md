...
- Optional time factor e^{−iωt}; show m and −m separately or summed. In the summed mode the −m term defaults to (−1)^ℓ e^{+iωt}, the nonprecessing-BBH symmetry h_{ℓ,−m} = (−1)^ℓ h*_{ℓm}.
